...
class RootViewModel {
  ...
  navData: any;
  navDataArray: ko.ObservableArray;
  ...
  constructor() {
    ...
    this.navData = [
      ...
      { path: "dashboard", detail: { label: "Dashboard", iconClass: "oj-ux-ico-bar-chart", addPath: this.addPath} },
      // { path: "incidents", detail: { label: "Incidents", iconClass: "oj-ux-ico-fire" } },
      // { path: "customers", detail: { label: "Customers", iconClass: "oj-ux-ico-contact-group" } },
      // { path: "about", detail: { label: "About", iconClass: "oj-ux-ico-information-s" } }
    ];
    this.navDataArray = ko.observableArray(this.navData);
    // router setup
    this.router = new CoreRouter(this.navData, {
    ...
    this.appName = ko.observable("Solar System");
    // user Info used in Global Navigation area

    this.userLogin = ko.observable("philip.paul@oracle.com");
    // footer
    this.footerLinks = [
  ...
  addPath = (path: string): void => {
    ...
    this.navData.push({path: path, detail: { label: "Test", iconClass: "oj-ux-ico-information-s" }});
    this.router.sync();
